...
def map_parallel(function, values, number_of_processes=None, chunksize=1):
    ...
    util.logging.debug('Creating multiprocessing pool with {} processes and chunksize {}.'.format(number_of_processes, chunksize))
...
# #
# #     util.logging.debug('Shared array with shape {} and lock {} created.'.format(shared_array, lock))
# #
# #     return shared_array
# #
# #
...
# #
# #     util.logging.debug('Creating pool with {} processes and chunksize.'.format(number_of_processes, chunksize))
# #
...
# #     pool.join()
# #
# #     util.logging.debug('Parallel calculation completed.')
# #
...
# #
# # def compute(index):
# #     util.logging.debug('Calculating for index {}.'.format(index))
